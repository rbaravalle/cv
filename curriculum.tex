...
\begin{small}
\begin{tabular}{ll}
\bf{\color{Gray}City} & Pasadena, USA\\
...
\begin{small}
\noindent
I have a PhD in Computer Science and experience in photo-realistic material modeling and simulation, image processing, deep learning, computer vision, robotics and computer graphics, among others. I have scientific publications in these fields as well as several years of working experience in the industry.
I am fluent in Spanish, English and French and a good team worker. I am interested in joining international teams that allows to expand my knowledge and experience.
\end{small}
...
\begin{tabular}{lcp{12 cm}}
		...
		\bf{2016} & & {\bf PhD. Computer Science} (Photo-realistic material modeling and simulation). Universidad Nacional de Rosario, Argentina. \\
		\bf{2010} & & {\bf Licenciateship in Computer Science}. Universidad Nacional de Rosario, Argentina. Academic Average: 9.4 ``Distinguished''.\\
\end{tabular}

\section*{\color{niceblue} \rule{2cm}{2.2pt} Work Experience}

\begin{itemize}
\item {\bf Freelance Contractor}, at {\em iRobot}: Image Processing and Deep Learning. January 2016 - Today.
...
\begin{itemize}
\item Programming and scripting languages: C++, C, Python, bash, Matlab, Javascript, ML, clojure.
\item git, SVN
\item Operating Systems: Linux, Windows, OS X.
\item Libraries: ROS, OpenGL, OpenCV, OpenCL, CUDA, Qt.
\item Deep Learning: Tensorflow-lite, Keras.
\end{itemize}
...
\begin{itemize}
\item {\bf Real-time Dense Map Fusion for Stereo SLAM}. Taihú Pire, Rodrigo Baravalle, Ariel D'alessandro and Javier Civera. {\it Robotica}, 2018. doi:10.1017/S0263574718000528.
