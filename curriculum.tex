...
\section*{\color{niceblue} Recent Publications \rule{10.2cm}{2.2pt}}

\subsection*{\color{niceblue} Journals}

\begin{itemize}
\item {\bf Real Time Dense Mapping for stereo-based SLAM systems}. Taihú Pire, Rodrigo Baravalle, Ariel D'alessandro and Javier Civera. {\it Robotica} journal, 2018. In press.
...
\begin{itemize}
\item January 2013 - December 2016, {\bf Multimedia signal processing - Applications to multimodal speech processing, automatic verification of handwritten signatures and non-linear system identification}. Project id: ING427. Acredited by Universidad Nacional de Rosario, Argentina.
\item January 2011 - December 2012, {\bf Digital image processing - Applications to audio-visual speech processing, digital watermarking, automatic recognition of handwritten signatures and recognition of vegetal species from leaf vein images}. Project id: ING355. Acredited by Universidad Nacional de Rosario, Argentina.
\end{itemize}
